...
export const CreateRecipe: React.FC = () => {
  ...
  const [ingredients, setIngredients] = useState<Ingredient[]>([
    { id: generateId(), name: '', quantity: '', unit: 'g', type: IngredientType.NORMAL, isTasteAdjustable: false }
  ]);
 ...
 useEffect(() => {
  ...
  const handleAddIngredient = () => {
    setIngredients([
      ...ingredients,
      { id: generateId(), name: '', quantity: '', unit: '', type: IngredientType.NORMAL, isTasteAdjustable: false, constantLimit: 0}
    ]);
  };
    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      ...
      <div className="bg-white rounded-3xl shadow-2xl shadow-stone-200/50 border border-white overflow-hidden">
        <div className="p-8 md:p-10 border-b border-stone-100 bg-gradient-to-r from-stone-50/50">
          ...
          <p className="text-stone-500 font-medium pl-[52px]">
            Define your base ingredients and scaling rules.
          </p>
        </div>
              ...
              <div className="group">
                ...
                <div className="relative w-40">
                  <input
                    ...
                    value={baseServings}
                    onChange={(e) =>
                      setBaseServings(parseInt(e.target.value) || 1)
                    }
                    className={`${inputStyles} pr-16 text-center text-xl font-bold`}
                  />
                  <span className="absolute right-4 top-1/2 -translate-y-1/2 text-stone-400 text-xs font-bold pointer-events-none uppercase">
                    Plates
                  </span>
                </div>
                <p className="text-xs text-stone-400 font-medium mt-3 leading-relaxed">
                  All ingredients entered below should correspond to this
                  amount.
                </p>
              </div>
            </div>
                ...
                {imageUrl ? (
                  <>
                    <img
                      ...
                      onError={(e) =>
                        (e.currentTarget.src =
                          "https://via.placeholder.com/800x600?text=Invalid+URL")
                      }
                    />
          ...
          <div>
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
              <div>
                ...
                <p className="text-stone-500 text-sm font-medium">
                  Add all components for the base serving size.
                </p>
              </div>
              <div className="text-xs font-bold text-stone-600 bg-stone-50 px-4 py-2 rounded-full border border-stone-200 flex items-center shadow-sm">
                ...
                "Constant" items (like pans/garnishes) don't scale until limit
                is hit.
              </div>
            </div>
            ...
            <div className="space-y-4">
              {ingredients.map((ing, index) => (
                <div
                  key={ing.id}
                  className={`group relative flex flex-col bg-white p-3 rounded-2xl border transition-all duration-300 ${
                    ...
                    <div className="flex-grow grid grid-cols-1 md:grid-cols-12 gap-3 w-full p-2">
                      ...
                      <div className="md:col-span-4 flex gap-2">
                        <div className="relative flex-grow">
                          ...
                          >
                            <option value={IngredientType.NORMAL}>
                              Linear Scaling
                            </option>
                            <option value={IngredientType.CONSTANT}>
                              Constant Limit
                            </option>
                          </select>
                        </div>
                        ...
                        >
                          <Flame
                            className={`w-5 h-5 ${
                              ing.isTasteAdjustable ? "fill-orange-500" : ""
                            }`}
                          />
                        </button>
                        ...
                        {ing.type === IngredientType.CONSTANT && (
                          <div
                            className="relative w-24 animate-fade-in flex-shrink-0 group/limit"
                            title="Keep quantity constant up to this many servings"
                          >
                            <input
                              type="number"
                              min="1"
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                updateIngredient(ing.id, "constantLimit", 0)
                              }
                      ...
                      <div className="bg-stone-50 p-4 rounded-xl border border-stone-200 shadow-inner">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div className="space-y-1.5">
                            <label className="text-xs font-bold text-green-700 uppercase tracking-tight">
                              Mild (Reduction %)
                            </label>
                            ...
                            <p className="text-[10px] text-stone-400 font-medium">
                              Decreases base amount
                            </p>
                          </div>

                          {/* Spicy */}
                          <div className="space-y-1.5">
                            <label className="text-xs font-bold text-orange-700 uppercase tracking-tight">
                              Spicy (Increase %)
                            </label>
                            <div className="relative">
                              <input
                            ...
                            <p className="text-[10px] text-stone-400 font-medium">
                              Increases base amount
                            </p>
                          </div>

                          {/* Indian Boost */}
                          <div className="space-y-1.5">
                            <label className="text-xs font-bold text-purple-700 uppercase tracking-tight">
                              Indian Boost (Increase %)
                            </label>
                            <div className="relative">
                              <input
                                type="number"
            ...
            <div className="flex flex-col md:flex-row justify-end items-end md:items-center gap-6">
              ...
              <div className="flex gap-4 w-full md:w-auto">
                <Button
                  ...
                  variant="secondary"
                  onClick={() => navigate("/")}
                  className="flex-1 md:flex-none px-6 py-3 h-auto text-stone-600 font-bold bg-stone-100 hover:bg-stone-200 rounded-xl"
                >
                  Cancel
                </Button>
                <Button
                  type="submit"
                  size="lg"
                  className="flex-1 md:flex-none px-8 py-3 h-auto shadow-xl shadow-chef-500/20 hover:shadow-chef-500/30 transition-all font-bold rounded-xl text-lg"
                >
              ...
              <div>
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-stone-200 border-dashed rounded-2xl cursor-pointer hover:bg-stone-50 hover:border-chef-400 transition-all group/upload relative overflow-hidden">
                  <div className="flex flex-col items-center justify-center pt-5 pb-6 z-10">
                    ...
                    <p className="mb-1 text-sm font-semibold text-stone-600 group-hover/upload:text-chef-700">
                      Upload from Device
                    </p>
